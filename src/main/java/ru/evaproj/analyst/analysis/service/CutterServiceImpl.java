...
public class CutterServiceImpl implements CutterService{
    ...
    * */
    @Override
    public List<CandleSegmentDto> cutHistory(String marketName, Integer timeframe, Integer lenght, Long fromTimestamp, Long toTimestamp, Double slRange, Double tpRange, CutterType type) {
        ...
        segmentList.putAll(cutter.cut(candleEntities, lenght, DealType.LONG, slRange, tpRange));
        segmentList.putAll(cutter.cut(candleEntities, lenght, DealType.SHORT, slRange, tpRange));
